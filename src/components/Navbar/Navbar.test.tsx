...
describe('Navbar', () => {
  ...
  it('links apontam para os hrefs corretos', () => {
    renderWithTheme(<Navbar />)
    expect(screen.getByTestId('nav-link-work')).toHaveAttribute('href', '/work')
    expect(screen.getByTestId('nav-link-studio')).toHaveAttribute('href', '/studio')
    expect(screen.getByTestId('nav-link-process')).toHaveAttribute('href', '/process')
  })
  ...
  it('CTA aponta para /contact', () => {
    renderWithTheme(<Navbar />)
    expect(screen.getByTestId('navbar-cta')).toHaveAttribute('href', '/contact')
  })
